...
public:
	void build() {
		...
		lights.push_back(new Light(vec3(2, 2, 3), vec3(500, 500, 500)));

		objects.push_back(new Sphere(vec3(0, 0.7, 0), 0.5, new Material(vec3(0.0, 0.0, 0.0), vec3(0.4, 0.6, 0.8))));
		objects.push_back(new Sphere(vec3(0.7, 0, 0), 0.5, new Material(vec3(0.0, 0.0, 0.0), vec3(0.8, 0.6, 0.4))));
		objects.push_back(new Sphere(vec3(-0.7, 0, 0), 0.5, new Material(vec3(0.6, 0.6, 0.6), vec3(0.0, 0.0, 0.0))));
		objects.push_back(new Plane(vec3(0, -0.5, 0), vec3(0, 1, 0), new Material(vec3(0, 0.8, 0), vec3(0.0, 0.0, 0.0))));
		objects.push_back(new Sphere(vec3(0, 0, 0), 5.0, new Material(vec3(0.3, 0.4, 0.9), vec3(0.0, 0.0, 0.0)),
...
void SaveTGAFile(const char* fileName, const std::vector<vec3>& image) {
...
int main(int argc, char* argv[]) {
	std::vector<vec3> image(screenWidth * screenHeight);	// create image
